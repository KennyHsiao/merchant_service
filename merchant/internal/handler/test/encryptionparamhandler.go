...
func EncryptionParamHandler(ctx *svc.ServiceContext) http.HandlerFunc {
	return func(w http.ResponseWriter, r *http.Request) {
		var req types.EncryptionParamRequest
		...
		l := test.NewEncryptionParamLogic(r.Context(), ctx)
		resp, err := l.EncryptionParam(&req)
		if err != nil {
