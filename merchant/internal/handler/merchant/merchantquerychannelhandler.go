...
func MerchantQueryChannelHandler(ctx *svc.ServiceContext) http.HandlerFunc {
	return func(w http.ResponseWriter, r *http.Request) {
		var req types.MerchantQueryChannelRequestX
		...
		l := merchant.NewMerchantQueryChannelLogic(r.Context(), ctx)
		resp, err := l.MerchantQueryChannel(&req)
		if err != nil {
