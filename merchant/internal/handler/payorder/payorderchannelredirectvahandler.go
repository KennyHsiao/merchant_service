...
func PayOrderChannelRedirectVAHandler(ctx *svc.ServiceContext) http.HandlerFunc {
	return func(w http.ResponseWriter, r *http.Request) {
		...
		l := payorder.NewPayOrderChannelRedirectVALogic(r.Context(), ctx)
		resp, err := l.PayOrderChannelRedirectVA(&req)
		if err != nil {
