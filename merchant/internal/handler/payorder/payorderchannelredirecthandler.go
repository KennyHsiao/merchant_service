...
func PayOrderChannelRedirectHandler(ctx *svc.ServiceContext) http.HandlerFunc {
	return func(w http.ResponseWriter, r *http.Request) {
		...
		l := payorder.NewPayOrderChannelRedirectLogic(r.Context(), ctx)
		resp, err := l.PayOrderChannelRedirect(req)
		if err != nil {
